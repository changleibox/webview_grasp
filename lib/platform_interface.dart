...
class CreationParams {
  ...
  /// Only Android. 是否支持视频全品播放
  final bool supportFullscreen;

  @override
  String toString() {
    return '$runtimeType(initialUrl: $initialUrl, settings: $webSettings, javascriptChannelNames: $javascriptChannelNames, userAgent: $userAgent, supportFullscreen: $supportFullscreen)';
  }
}
