...
class WebView extends StatefulWidget {
  ...
  const WebView({
    ...
    this.supportFullscreen = false,
        ...
        assert(mixedContentMode != null),
        assert(supportFullscreen != null),
        super(key: key);
...
CreationParams _creationParamsfromWidget(WebView widget) {
  return CreationParams(
    ...
    supportFullscreen: widget.supportFullscreen,
  );
}
...
WebSettings _clearUnchangedWebSettings(WebSettings currentValue, WebSettings newValue) {
  ...
  assert(newValue.mixedContentMode != null);
