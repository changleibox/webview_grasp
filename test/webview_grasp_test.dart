...
import 'package:webview_grasp/platform_interface.dart';
import 'package:webview_grasp/webview_grasp.dart';
...
class FakePlatformWebView {
  ...
  void fakeNavigate(String url) {
    ...
    _ambiguate(ServicesBinding.instance)!.defaultBinaryMessenger.handlePlatformMessage(channel.name, data,
        (ByteData? data) {
